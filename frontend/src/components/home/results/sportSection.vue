<script setup>
  import img from '@/assets/img/depor.jpeg'
</script>
<template>
  <div class="w-full mt-16">
    ...
    <div class="flex w-full mt-8">
      <div class="box-loterys2 mx-6 w-4/5  flex justify-between flex-col items-center">
        <img :src="img" alt="" class="depor__img w-full">
