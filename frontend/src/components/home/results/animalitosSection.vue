...
<template>
  <div class="w-full mt-16">
    ...
    <div class="flex w-full md:mt-8 mt-0">
      <div class="box-loterys md:mx-6 pt-6 flex justify-between flex-col items-center mt-5 md:mt-0"
        v-for="(n, index) in animalitos" :key="index">
        <img :src="n" alt="">
        <div class="pb-2 pt-3 mt-10 w-full text-center bg-blue-800 buttonBuy__contanier relative">
          ...
          <button class="absolute buyButton flex items-center justify-center">
            <svg class="mr-1 ws-icon" fill="none" stroke="#ffffff" width="1.7rem" height="1.7rem" viewBox="0 0 192 192"
