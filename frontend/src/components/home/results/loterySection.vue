<script setup>
import img1 from '@/assets/img/logo_tripledorado.webp'
import img2 from '@/assets/img/logo_tripletachira.webp'
import img3 from '@/assets/img/logo_supergana.webp'
...
<template>
  <div class="w-full">
    ...
    <div class="flex w-full mt-8">
      <div class="box-loterys mx-6 pt-6 flex justify-between flex-col items-center" v-for="(lotery, index) in loterys" :key="index">
        <img :src="lotery" alt="">
