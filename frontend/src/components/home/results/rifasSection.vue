<script setup>
import img1 from '@/assets/img/rifa1.png'
import img2 from '@/assets/img/rifa2.png'
const rifas = [
 {
  img: img1,
  text: 'Equipa tu hogar!'
 },
 {
  img: img2,
  text: 'Ganate un carro 0Km!'
 },
...
<template>
  <div class="w-full mt-16">
    ...
    <div class="flex w-full mt-8">
      <div class="w-1/2 px-5" v-for="(rifa, index) in rifas" :key="index">
        <div class="box-loterys2 mx-6 w-full flex justify-between flex-col items-center">
          <img :src="rifa.img" alt="" class="depor__img w-full">
          <div class="pb-2 pt-3  w-full text-center bg-blue-800 buttonBuy__contanier relative">
            <div class="text-white py-3" style="font-weight: 700;" >
              {{rifa.text}}
            </div>
            <button  class="absolute buyButton2 flex items-center justify-center">
