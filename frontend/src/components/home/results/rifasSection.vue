...
<template>
  <div class="w-full mt-16">
    ...
    <div class="flex w-full md:mt-8 mt-0">
      <div class="md:w-1/2 md:px-5 mt-5 w-full " v-for="(rifa, index) in rifas" :key="index">
        <div class="box-loterys2 md:mx-6 md:pt-6 flex justify-between flex-col items-center mt-8 md:mt-0">
          ...
          <div class="pb-2 pt-3  w-full text-center bg-blue-800 buttonBuy__contanier relative">
            ...
            <button class="absolute buyButton2 flex items-center justify-center">
              <svg class="mr-1 ws-icon" fill="none" stroke="#ffffff" width="1.7rem" height="1.7rem"
