...
<template>
  <header class="md:px-24 bg-blue-800 py-6 header-box fixed w-full flex  items-center">
    <RouterLink to="/">
      <div class="rowdies-bold md:text-4xl text-3xl text-white header-box__logo">El Ministro.com</div>
    </RouterLink>
    <div class="menu_bar">
