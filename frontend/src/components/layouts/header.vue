...
<template>
  <header  class="md:px-24 bg-blue-800 py-6 header-box flex md:justify-between items-end">
    <RouterLink to="/">
      <div class="rowdies-bold text-4xl  text-white header-box__logo">El Ministro.com</div>
    </RouterLink>
    <div >
      <ul class="flex items-center">
        <li class="mx-6 px-6 text-center text-lg link-direct">
          <div class="relative text-white text-center w-full" style="z-index: 2;">
            <RouterLink to="/lotery-result" activeClass="active">
              Loterias
            </RouterLink>
          </div>
        </li>
        <li class="mx-6 px-6 text-center text-lg link-direct">
          <div class="relative text-white text-center w-full" style="z-index: 2;">
            <RouterLink to="/animalitos-result" activeClass="active">
              Animalitos
            </RouterLink>
          </div>
        </li>
        <li class="mx-6 px-6 text-center text-lg link-direct">
          <div class="relative text-white text-center w-full" style="z-index: 2;">
            <RouterLink to="/sport-result" activeClass="active">
              Deportes
            </RouterLink>
          </div>
        </li>
        <li class="mx-6 px-6 text-center text-lg link-direct">
          <div class="relative text-white text-center w-full" style="z-index: 2;">
            <RouterLink to="/rifas-result" activeClass="active">
              Rifas
            </RouterLink>
          </div>
        </li>
        <li>
          <button  class=" top__button flex items-center justify-center">
